...
public class FramePieCharts extends JFrame {
	...
	BufferedImage pie_party_packingm_byvoter;
			    ...
			    graphics.drawImage(MainFrame.mainframe.panelStats.pie_party_votes, xs * 2,5,100,100,null);
			    ...
			    graphics.drawImage(MainFrame.mainframe.panelStats.pie_eth_pop, xs * 2,5+ h + ys,100,100,null);
			    ...
			    graphics.drawString("Partisan votes", xs * 2 + w / 2 - graphics.getFontMetrics().stringWidth("Partisan votes")/2, 5+h+20);
			    ...
			    graphics.drawString("Minority population", xs * 2 + w / 2 - graphics.getFontMetrics().stringWidth("Minority population")/2, 5+h*2+ ys +20);
