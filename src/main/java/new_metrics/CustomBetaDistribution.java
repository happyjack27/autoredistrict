...
/**
 * Implements the Beta distribution. Customized from org.apache.commons.commons-math3 BetaDistribution.
 *
 * @see <a href="http://en.wikipedia.org/wiki/Beta_distribution">Beta distribution</a>
 * @since 2.0 (changed to concrete class in 3.0)
 */
public class CustomBetaDistribution extends AbstractRealDistribution {
    ...
    public CustomBetaDistribution(double[] xs) {
        this(xs, false);
    }
    public CustomBetaDistribution(double[] xs, boolean force_centered) {
    ...
    public double sample_variance(double[] xs) {
        ...
        var /= (double)(xs.length - CustomBetaDistribution.variance_regularization);
        if (CustomBetaDistribution.sqrt) {
            var = Math.sqrt(var);
        }
        var *= var_mult;
        return var;
     ...
     */
    public CustomBetaDistribution(double alpha, double beta) {
     ...
     * @since 2.1
     */
    public CustomBetaDistribution(double alpha, double beta, double inverseCumAccuracy) {
     ...
     * @since 3.3
     */
    public CustomBetaDistribution(RandomGenerator rng, double alpha, double beta) {
     ...
     * @since 3.1
     */
    public CustomBetaDistribution(RandomGenerator rng,
                            double alpha,
                            double beta,
