...
/**
 * Implementation of the Gamma distribution. Customized from org.apache.commons.commons-math3 GammaDistribution.
 *
...
public class CustomGammaDistribution extends AbstractRealDistribution {
     ...
     * @since 3.1
     */
    public CustomGammaDistribution(double[] xs) {
    ...
    public CustomGammaDistribution(RandomGenerator rng,
                             double shape,
                             double scale,
